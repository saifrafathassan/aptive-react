      ...
      <div className="container">
        ...
        <div className='bottom-content'>
            <div className="card">
                ...
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates accusamus laudantium nostrum atque, quia facilis fuga provident neque hic dolores.</p>
            </div>
            <div className="card">
                <div>
